...
private:
  ...
  double m_heightAboveZ;  //!< antenna height above the node's Z coordinate
    ...
    //ElliottDobbs 823004322
    class GausLogDistancePropagationLossModel : public PropagationLossModel
    {
    public:
        /**
         * \brief Get the type ID.
         ...
         */
        static TypeId GetTypeId (void);
        GausLogDistancePropagationLossModel ();
    ...
    private:
         ...
         * Defined and unimplemented to avoid misuse
         */
        GausLogDistancePropagationLossModel (const GausLogDistancePropagationLossModel &);
        /**
         * \brief Copy constructor
         *
         * Defined and unimplemented to avoid misuse
         * \returns
         */
        GausLogDistancePropagationLossModel & operator = (const GausLogDistancePropagationLossModel &);
        ...
        Ptr<RandomVariableStream> m_Gvariable; //!< gaussian random variable
    };
